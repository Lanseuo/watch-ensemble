    ...
    render() {
        return (
            <aside className={styles.container}>
                ...
                <div className={`${styles.wrapper} ${styles.toggleChatWindowWrapper}`} onClick={this.toggleShowChatWindow}>
                    ...
                    {this.props.chatUnreadMessages && <div className={styles.unreadMessagesIndicator}></div>}
                </div>
...
const mapStateToProps = (state: AppState) => ({
    ...
    chatUnreadMessages: state.chat.hasUnreadMessages
})
